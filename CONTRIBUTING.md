...
First off, thank you for considering contributing to ucode.
...
[issue tracker](https://github.com/daxartio/ucode/issues),
...
```shell
git clone https://github.com/daxartio/ucode
cd ucode
cargo test
```
